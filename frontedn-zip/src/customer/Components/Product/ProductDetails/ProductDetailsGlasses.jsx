          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                          ...
                          {({ active, checked }) => (
                            <>
                              ...
                              {size.inStock ? (
                                ...
                                >
                                  <svg
                                    className="thesvg absolute inset-0 h-full w-full stroke-2 text-gray-200"
                                    viewBox="0 0 100 100"
                ...
                <a href="/augmentFace">Augmented reality</a>
              </form>
            </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3 pb-10">
                  ...
                  <p className="opacity-60">696 Ratings</p>
                </div>
                <Box>
                  <Grid
                    container
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">59</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">19</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">25</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
