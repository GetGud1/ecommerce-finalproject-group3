        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="mens_clothing">Men</MenuItem>
                <MenuItem value="womens_clothing">Women</MenuItem>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value="men_jeans">Mens jeans</MenuItem>
                ...
                <MenuItem value="women_jacket">Jackets</MenuItem>
                ...
                <MenuItem value="sunglasses">Glasses</MenuItem>
